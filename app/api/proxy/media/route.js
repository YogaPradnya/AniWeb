...
export async function GET(request) {
  ...
  // Browser modern secara alami akan meminta potongan video (Range Request) sesuai kebutuhannya.
  // Dengan Edge Runtime, kita tidak perlu membagi 5MB secara manual di sini.
  // Data akan "mengalir" (stream) dari upstream langsung ke browser pengguna secara real-time.
  if (range) {
    headers['Range'] = range;
  }
